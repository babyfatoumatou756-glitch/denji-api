...
app.get('/api/denji', async (req, res) => {
    ...
    try {
        ...
        // On simplifie l'envoi pour éviter les erreurs de format d'historique
        ...
        // Mise à jour de l'historique en local
        ...
        res.json({ 
            status: false, 
            error: "Erreur API", 
            message: e.response ? "Problème avec la clé ou le format Google" : e.message 
        });
    }
});
